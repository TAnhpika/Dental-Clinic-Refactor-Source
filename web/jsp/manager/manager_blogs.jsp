        ...
        <main class="dashboard-main">
            ...
            <div class="dashboard-content">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h4 class="mb-1"><i class="fas fa-blog me-2"></i>Kiểm duyệt Blog Y khoa</h4>
                        <p class="text-muted mb-0">Quản lý và kiểm duyệt các bài viết y khoa</p>
                    </div>
                    <button class="btn-dashboard btn-dashboard-primary" data-bs-toggle="modal" data-bs-target="#addBlogModal">
                ...
                <div class="row g-4 mb-4">
                    <div class="col-12 col-sm-6 col-xl-4">
                        <div class="stat-card">
                            ...
                            <div class="stat-card-value"><%= blogs.size() %></div>
                    ...
                    <div class="table-responsive">
                        <table class="dashboard-table" id="blogsTable">
                            ...
                            <tbody>
                                ...
                                <tr data-category="<%= blog.getCategory() %>" data-status="<%= blog.getStatus() %>">
                                    <td><span class="badge bg-secondary">#<%= blog.getId() %></span></td>
                                    <td>
                                        <img src="<%= blog.getImage() != null ? blog.getImage() : request.getContextPath() + "/img/default-blog.jpg" %>" 
                                             class="rounded" style="width: 80px; height: 50px; object-fit: cover;" alt="Blog Image">
                                    </td>
                                    <td>
                                        ...
                                        <small class="text-muted" style="display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;">
                                            <%= blog.getContent() != null ? blog.getContent().substring(0, Math.min(100, blog.getContent().length())) + "..." : "" %>
                                        </small>
                                    </td>
                                    <td><%= blog.getAuthor() %></td>
                                    <td><span class="badge-dashboard badge-info"><%= blog.getCategory() %></span></td>
                                    <td><%= blog.getCreatedAt() %></td>
                                    <td>
                                        <span class="badge bg-<%= "PENDING".equals(blog.getStatus()) ? "warning" : "APPROVED".equals(blog.getStatus()) ? "success" : "danger" %>">
                                            <%= "PENDING".equals(blog.getStatus()) ? "Chờ duyệt" : "APPROVED".equals(blog.getStatus()) ? "Đã duyệt" : "Từ chối" %>
                                        </span>
                                    </td>
                                    <td>
                                        ...
                                        <button class="btn btn-sm btn-outline-success me-1" title="Duyệt">
