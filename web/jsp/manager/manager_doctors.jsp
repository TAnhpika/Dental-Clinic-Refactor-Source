        ...
        <main class="dashboard-main">
            ...
            <div class="dashboard-content">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h4 class="mb-1"><i class="fas fa-user-md me-2"></i>Quản lý Bác sĩ</h4>
                        <p class="text-muted mb-0">Danh sách và thông tin chi tiết các bác sĩ</p>
                    </div>
                    <button class="btn-dashboard btn-dashboard-primary" data-bs-toggle="modal" data-bs-target="#addDoctorModal">
                ...
                <div class="row g-4 mb-4">
                    <div class="col-12 col-sm-6 col-xl-3">
                        <div class="stat-card">
                            ...
                            <div class="stat-card-value"><%= doctors.size() %></div>
                    ...
                    <div class="col-12 col-sm-6 col-xl-3">
                        <div class="stat-card danger">
                            ...
                            <div class="stat-card-value"><%= doctors.size() - activeCount - leaveCount %></div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="searchInput" placeholder="Tìm kiếm bác sĩ..." onkeyup="filterDoctors()">
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <select class="form-select" id="statusFilter" onchange="filterDoctors()">
                    ...
                    <div class="col-md-6 col-lg-4 doctor-item" 
                        ...
                        <div class="doctor-card">
                            <div class="d-flex align-items-center mb-3">
                                <img src="<%= doctor.getAvatar() != null ? doctor.getAvatar() : request.getContextPath() + "/img/default-avatar.png" %>" 
                                     class="doctor-avatar me-3" alt="Doctor Avatar">
                                <div>
                                    <h6 class="mb-1"><%= doctor.getName() %></h6>
                                    <span class="text-muted" style="font-size: 13px;"><%= doctor.getSpecialty() %></span>
                                </div>
                            </div>
                            <div class="mb-3">
                                <span class="specialty-badge">
                                    <i class="fas fa-graduation-cap"></i> <%= doctor.getDegree() %>
                                </span>
                                <span class="specialty-badge">
                                    <i class="fas fa-clock"></i> <%= doctor.getExperience() %> năm KN
                                </span>
                            </div>
                            <div class="mb-3" style="font-size: 13px;">
                                <p class="mb-1"><i class="fas fa-envelope me-2 text-muted"></i><%= doctor.getEmail() %></p>
                                <p class="mb-0"><i class="fas fa-phone me-2 text-muted"></i><%= doctor.getPhone() %></p>
                            </div>
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="badge bg-<%= "ACTIVE".equals(doctor.getStatus()) ? "success" : "ON_LEAVE".equals(doctor.getStatus()) ? "warning" : "danger" %>">
                                    <%= "ACTIVE".equals(doctor.getStatus()) ? "Đang làm việc" : "ON_LEAVE".equals(doctor.getStatus()) ? "Nghỉ phép" : "Không hoạt động" %>
                                </span>
                                <div>
                                    <button class="btn btn-sm btn-outline-info me-1" title="Xem lịch">
                                        <i class="fas fa-calendar-alt"></i>
                                    </button>
                                    <button class="btn btn-sm btn-outline-warning me-1" title="Chỉnh sửa">
                                        <i class="fas fa-edit"></i>
                                    </button>
                                    <button class="btn btn-sm btn-outline-danger" title="Xóa" onclick="confirmAction('Bạn có chắc muốn xóa bác sĩ này?', function() { deleteDoctorAction(<%= doctor.getUserId() %>); })">
            ...
            <div class="modal-content">
                ...
                <form action="${pageContext.request.contextPath}/AddDoctorServlet" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Bằng cấp <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="degree" required placeholder="VD: Thạc sĩ, Tiến sĩ">
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="description" rows="3" placeholder="Giới thiệu về bác sĩ..."></textarea>
                        </div>
                    </div>
