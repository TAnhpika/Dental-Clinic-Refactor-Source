...
public class PayOSConfig {
    ...
    public static String getClientId() { return Env.get("PAYOS_CLIENT_ID"); }
    public static String getApiKey() { return Env.get("PAYOS_API_KEY"); }
    public static String getChecksumKey() { return Env.get("PAYOS_CHECKSUM_KEY"); }
