...
public class PayOSServlet extends HttpServlet {
    ...
    private static String getPayosClientId() { return PayOSConfig.getClientId(); }
    private static String getPayosApiKey() { return PayOSConfig.getApiKey(); }
    private static String getPayosChecksumKey() { return PayOSConfig.getChecksumKey(); }
    ...
    private void handlePaymentSuccess(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // ✅ Xóa selectedService sau khi thanh toán thành công để người dùng có thể chọn dịch vụ mới
    ...
    //===============================================================================
    // Xử lý các yêu cầu HTTP POST, chủ yếu để nhận webhook từ ngân hàng (MB Bank) hoặc xử lý các request JSON.
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("webhook".equals(action) || (contentType != null && contentType.contains("application/json"))) {  // nếu có các action là ;à webhook hoặc là application/json -> gọi handleMBBankWebhook để xử lý thông báo giao dịch từ ngân hàng.
   ...
   /**
    ...
    private String generateFallbackQR(Bill bill) {
        ...
        try {
            ...
            String qrData = String.format("https://img.vietqr.io/image/MB-5529062004-compact2.png?amount=%d&addInfo=Thanh%%20toan%%20hoa%%20don%%20%s", 
                amount, orderId);
