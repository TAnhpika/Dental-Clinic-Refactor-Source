...
public class GoogleCallbackServlet extends HttpServlet {
      private static String getClientId() { return utils.Env.get("GOOGLE_CLIENT_ID"); }
      private static String getClientSecret() { return utils.Env.get("GOOGLE_CLIENT_SECRET"); }
    ...
    public void init() throws ServletException {
        ...
        REDIRECT_URI = "http://localhost:8080" + contextPath + "/LoginGG/LoginGoogleHandler";                                     // REDIRECT_URI – tức là URL mà Google sẽ redirect người dùng về sau khi đăng nhập thành công.
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (code != null) {                                                                                                                                                                    // Nếu có code -> tức là đăng nhập thành công bên Google
            ...
            response.sendRedirect(request.getContextPath() + "/auth/login.jsp?error=no_auth_code");
        }
    }
} 